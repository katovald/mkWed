...
import 'package:m_k_w/commons/common.dart';

export 'package:m_k_w/commons/common.dart';
export 'package:flutter/widgets.dart';

enum SignInOptions { standard, games }

class GoogleLogin {
  GoogleLogin._(this._data);
...
class GoogleSignInAccount implements GoogleIdentity {
  GoogleSignInAccount._(this._googleSignIn, Map<String, dynamic> data)
      : nombre = data['displayName'],
        mail = data['email'],
        id = data['id'], photoUrl = data['photoUrl'], _idToken = data['idToken'] {
    assert(id != null);
  }
  ...
  Future<GoogleLogin> get authentication async {
  ...
  bool operator ==(dynamic other) {
    ...
    return nombre == otherAccount.nombre &&
        mail == otherAccount.mail &&
        id == otherAccount.id &&
  ...
  @override
  int get hashCode => hashValues(nombre, mail, id, photoUrl, _idToken);
...
class GoogleSignIn {
  ...
  factory GoogleSignIn.standard({List<String> scopes, String hostedDomain}) {
    return GoogleSignIn(
        signInOption: SignInOptions.standard,
        scopes: scopes,
  ...
  factory GoogleSignIn.games() {
    return GoogleSignIn(signInOption: SignInOptions.games);
  }
  ...
  /// not be used on iOS.
  final SignInOptions signInOption;
  ...
  Future<void> _ensureInitialized() {
    if (_initialization == null) {
      _initialization = channel.invokeMethod<void>('init', <String, dynamic>{
        'signInOption': (signInOption ?? SignInOptions.standard).toString(),
